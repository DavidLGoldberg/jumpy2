...
- Vim modes supported:
    - command mode
    - insert mode
- 🆕 Now publishes to the _Open VSX Registry_ for **VSCodium** and **Cursor**! Download it here: [Jumpy2 on the OVSX Registry](https://open-vsx.org/extension/DavidLGoldberg/jumpy2)
